...
export function Header(props: HeaderProps) {
  return (
    <div className="flex relative items-center gap-2 px-8 pt-12 md:pt-0">
      <Link
        href="/#projects"
      ...
      <div className="flex flex-col gap-1 md:gap-1 px-6">
        <h1 className="text-zinc-200 text-3xl text-center md:text-left md:text-4xl font-medium">
          {props.title}
        </h1>
        {props.subtitle ? (
